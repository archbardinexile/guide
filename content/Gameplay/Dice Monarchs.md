...
A player's hand can only be made of 1d4, 1d6, 1d8, 1d10 and 1d12. For example, a player's hole d4 cannot be used together with the community d4. If two or more players have a hand with the same value, the player with the highest value hole dice wins. Even hands are considered higher value than odd hands.
